...
class TweetBox extends React.Component {
  ...
  handleChange(event) {
    /*
      ...
      When invoked, `event.target.value` is the value of the textarea. We need to modify
       the component's state here, which will eventually lead to a re-render and a UI update.
    */
  }
  ...
  handleSubmit() {
    /*
      ...
      When invoked, we can access the current state of the component. We need to call
       `postTweet` and then reset the component's state.
    */
  }
